                ...
                <div className='mt-2'>
                  <div className='flex rounded-md bg-white/5 ring-1 ring-inset ring-white/10 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500'>
                    ...
                    <input
                      ...
                      className='w-full sm:w-auto flex-1 border-0 bg-white py-1.5 pl-1 text-black focus:ring-0 sm:text-sm sm:leading-6'
                      placeholder='SuperDuperShortCode'
                    />
                    <svg
                      viewBox='0 0 24 24'
                      xmlns='http://www.w3.org/2000/svg'
                      className='my-auto w-6 h-6 mr-1 cursor-pointer dark:text-white text-black'
                      onClick={handleCopy}
                    >
